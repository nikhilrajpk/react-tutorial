...
// import { Check, X, Camera, ChevronRight } from 'lucide-react';
...
//             SNAPFY
//           </h1>
//           {/* <p className="text-white/70 mt-2 text-lg font-light tracking-wider">Create your story</p> */}
//         </div>
...
//                 />
//                 {errors.username && (
//                   <p className="mt-1 text-[#FF6C37] text-sm flex items-center">
...
//               <a href="/login" className="text-[#FF6C37] hover:text-white hover:underline transition-colors">
//                 Log in
//               </a>
//             </p>
//           </form>
